...
INSERT INTO categories (name, slug, description, seo_title, seo_description, display_order) VALUES
  ...
  ('채무·금전', 'debt-finance', '채무와 금전 거래 관련 법률', '채무·금전 법률 자문 | 法 BLOG', '돈 빌리기, 채권 추심, 이자 제한, 사채, 연대보증 등 채무 관련 실무 정보', 10),
  ('행정·기타', 'admin-etc', '행정 절차 및 기타 법률 상담', '행정·기타 법률 상담 | 法 BLOG', '행정심판, 민원, 공공기관 민원, 기타 법률 상담 정보', 11),
  ('계약·거래', 'contract-trade', '계약 체결 및 상거래 법률', '계약·거래 법률 자문 | 法 BLOG', '계약서 검토, 위약금, 계약 위반, 상거래 분쟁 등 실무 정보', 12),
  ('전세·임대차', 'lease-rental', '전세와 임대차 관련 법률', '전세·임대차 법률 자문 | 法 BLOG', '전세보증금, 임대차 계약, 계약 갱신, 보증금 반환 등 실제 사례', 13)
