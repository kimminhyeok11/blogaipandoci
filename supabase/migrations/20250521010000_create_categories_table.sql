...
INSERT INTO categories (name, slug, description, seo_title, seo_description, display_order) VALUES
  ('형사', '형사', '형사법 관련 모든 절차와 판례', '형사 사건 절차와 법률 정보 | 法 BLOG', '형사 고소, 피고, 합의금, 재판 과정까지 실제 사례 기반 정보', 1),
  ('민사', '민사', '민사법 관련 분쟁 해결', '민사 소송 및 분쟁 해결 | 法 BLOG', '채무, 계약, 손해배상 등 민사 절차 실무 정보', 2),
  ('이혼·가족', '이혼·가족', '이혼과 가족 관련 법률', '이혼 절차와 가족법 | 法 BLOG', '이혼 소송, 양육권, 재산분할, 위자료 실제 사례', 3),
  ('노동', '노동', '근로자와 사용자 간 분쟁', '노동법과 근로자 권리 | 法 BLOG', '부당해고, 임금체불, 산재보상 노동 분쟁 정보', 4),
  ('부동산', '부동산', '부동산 관련 법률', '부동산 법률 및 분쟁 | 法 BLOG', '임대차, 매매, 경매, 분쟁 부동산 법률 정보', 5),
  ('학교폭력', '학교폭력', '학교 내 폭력 사건 처리', '학교폭력 피해 구제 및 절차 | 法 BLOG', '학교폭력 실태조사, 가해 학생 처분, 피해 회복', 6),
  ('지식재산권', '지식재산권', '저작권, 특허, 상표권', '지식재산권 보호와 침해 | 法 BLOG', '저작권 침해, 특허 분쟁, 상표권 침해 실사례', 7)
