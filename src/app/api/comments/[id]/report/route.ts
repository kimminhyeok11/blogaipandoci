...
async function sendTelegramAlert(message: string) {
  if (!TELEGRAM_BOT_TOKEN || !TELEGRAM_CHAT_ID) {
    console.error("[Telegram Report] Missing environment variables:", {
  ...
  try {
    ...
    if (!response.ok) {
      ...
      console.error("[Telegram Report] API error:", {
    ...
    console.log("[Telegram Report] Message sent successfully");
  } catch (error) {
    console.error("[Telegram Report] Network error:", error);
  }
}
