...
export async function generateStaticParams() {
  try {
    ...
    if (!supabaseUrl || !supabaseAnonKey) {
      console.error("[generateStaticParams] Environment variables not set, returning empty array");
      return [];
    }
    ...
    if (!posts || posts.length === 0) {
      console.log("[generateStaticParams] No published posts found, returning empty array");
      return [];
    }
